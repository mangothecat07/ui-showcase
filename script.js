(function (_, D) {
  ...
  var as = (_, D, g) =>
    D in _
      ? rs(_, D, { enumerable: !0, configurable: !0, writable: !0, value: g })
      : (_[D] = g);
  var L = (_, D, g) => as(_, typeof D != "symbol" ? D + "" : D, g);
  let D = 0;
  function g() {
    if (!(D > 100)) {
      if (D === 100)
  ...
  class Ve {
    constructor(e, { parent: t, vertexShader: s, fragmentShader: i } = {}) {
      ...
      (this.renderer = e),
        (this.gl = this.renderer.gl),
        (this.parent = t),
        (this.defaultVsCode = this.parent.type === "Plane" ? ot : dt),
        (this.defaultFsCode = this.parent.type === "Plane" ? lt : ct),
        s
          ? (this.vsCode = s)
          : (!this.renderer.production &&
...
`,
    ...
    createUniforms(e) {
      (this.uniformsManager = new ht(this.renderer, this.program, e)),
        this.setUniforms();
    }
    setUniforms() {
...
gl.LINEAR filtering will be used instead`
    ...
    _getSizes() {
      ...
      const e = this._parent.scale
        ? Ce.set(this._parent.scale.x, this._parent.scale.y)
        : Ce.set(1, 1),
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(Ce.set(0.001, 0.001)),
    ...
    _updateTextureMatrix(e) {
      ...
      (t.x /= this.scale.x),
        (t.y /= this.scale.y),
        (this._textureMatrix.matrix = pt.setFromArray([
          t.x,
          0,
          0,
          0,
  ...
  class mt {
    constructor(
      ...
      (this._canDraw = !1),
        ...
        (o = parseInt(o)),
        (l = parseInt(l)),
        (this._geometry = new ut(this.renderer, { width: o, height: l })),
    ...
    _initMesh() {
      (this.uuid = Me()),
        (this.loader = new gt(this.renderer, this, {
          sourcesLoaded: 0,
          initSourcesToLoad: 0,
          complete: !1,
          onComplete: () => {
...
`,
  ...
  class xt extends mt {
    ...
    mouseToPlaneCoords(e) {
      const t = this.scale ? this.scale : _t.set(1, 1),
        s = We.set(
  ...
  class He extends xt {
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(bt.set(0.001, 0.001)),
  ...
  typeof document.hidden < "u"
    ? ((Pe = "hidden"), (ce = "visibilitychange"))
    : typeof document.msHidden < "u"
      ? ((Pe = "msHidden"), (ce = "msvisibilitychange"))
      : typeof document.webkitHidden < "u" &&
      ((Pe = "webkitHidden"), (ce = "webkitvisibilitychange"));
  function zt(n, e) {
    let t;
    return function (...s) {
      clearTimeout(t),
  ...
  function je(n, e) {
    ...
    c.setAttribute("data-us-text", n.local.id),
      (c.style.cssText = `width:${t}px;top:${h}px;left:${o}px;font-size:${i}px;line-height:${r}px;letter-spacing:${a}px;font-family:${n.fontFamily
        };font-weight:${n.fontWeight};text-align:${n.textAlign
  ...
  function Xe() {
    _.scenes
      .filter((e) => !document.body.contains(e.element))
      .forEach((e) => {
        e.curtain && e.curtain.dispose();
        const t = _.scenes.indexOf(e);
        t !== -1 && _.scenes.splice(t, 1);
      });
  }
  function Ut(n) {
    return (
    ...
    const e = (t) => {
      ...
      n.forEach((i) => {
        ...
        ((G = window.scrollY || window.pageYOffset),
          ...
          (ue = t),
          (he > 1e3 || (he < 0 && !Fe && !G)) && Le()),
        s ? ($t(), (fe = requestAnimationFrame(e))) : cancelAnimationFrame(fe);
    };
    n.length && (fe = requestAnimationFrame(e));
  }
  function _e(n, e, t) {
  ...
  function Ye(n, e, t) {
    if (K) {
      n.loadCanvas(K, { sampler: "uTexture" });
      return;
    }
  ...
  class $e {
    constructor(e, t) {
      ...
      (this.locked = e.locked || !1),
        ...
        (this.breakpoints = Nt(e.breakpoints || [])),
        (this.local.sceneId = t),
        (this.local.id = me()),
        (this.states = {
          appear:
            e.states && e.states.appear
              ? e.states.appear.map((s) => new Vt(s))
              : [],
          scroll:
            e.states && e.states.scroll
              ? e.states.scroll.map((s) => new Bt(s))
              : [],
          hover:
            e.states && e.states.hover
              ? e.states.hover.map((s) => new Wt(s))
              : [],
        });
    }
    state() {
  ...
  class Ht extends ze {
    ...
    unpackageType() {
      return (
        (this.fill = te(this.fill)),
        (this.stroke = te(this.stroke)),
        this.render(),
        this
      );
    }
  ...
  class Xt extends ze {
    ...
    unpackage() {
      return (
        (this.fill = te(this.fill)), (this.effects = te(this.effects)), this
      );
    }
    loadFont() {
      var o;
    ...
    render() {
      ...
      const C = (b, P, S, x, I, $, re) => {
        let B = P.split("").reduce(
          (z, ee, is) =>
            z + b.measureText(ee).width + (is < P.length - 1 ? I : 0),
          0
        ),
          W;
        if (
          ($ === "center" ? (W = S + (re - B) / 2 - re / 2) : (W = S),
            $ === "right")
        )
          for (let z = P.length - 1; z >= 0; z--) {
            const ee = P[z];
            (W -= b.measureText(ee).width),
              b.fillText(ee, W, x),
              z > 0 && (W -= I);
          }
        else
...
`)
      ...
      const Y = (b, P, S) =>
        P.split("").reduce(
          (I, $, re) => (
            (I += b.measureText($).width), re < P.length - 1 && (I += S), I
          ),
          0
        );
      for (let b = 0; b < O; b++) {
...
` && y.push(I);
              ...
              for (; B.length > 0;) {
                ...
                for (
                  let ee = 0;
                  ee < B.length &&
                  (t.measureText(z + B[ee]).width <= r || ee == 0);
                  ee++
                )
                  z += B[ee];
                (B = B.slice(z.length)),
  ...
  function Le() {
    _.scenes
      ...
      .forEach((n) => {
        ...
        (n.scrollY = G),
          n.lastBbox &&
          (Math.abs(e.top - n.lastBbox.top) === 0 && he > 0
  ...
  class qt {
    ...
    resize() {
      this.setCanvasScale(),
        ...
        K &&
        ((K.width = this.canvasWidth * 0.01),
          (K.height = this.canvasHeight * 0.01)),
        (this.lastBbox = this.bbox),
        (this.bbox = this.element.getBoundingClientRect()),
        (this.currentBreakpoint = this.breakpoints.find(
          (e) => J >= e.min && J <= e.max
            ...
            (e.setBreakpointValues(),
              ...
              Object.keys(e.local.bpProps).forEach((i) => {
                e.getPlanes().forEach((r) => {
                  r.uniforms[i] && Se(e.local.bpProps[i], r.uniforms[i], i);
                });
              })),
    ...
    getDynamicLayers() {
      return this.layers.filter((e) => le(e));
    }
    createCurtains() {
      if (
        ((this.curtain = new nt({
      ...
      if (s) {
        let i = s.parentLayer ? s.getParent() : null,
          ...
          a =
            ...
            i.effects &&
            i.effects.length &&
            i.getChildEffectItems().filter((h) => le(h)).length;
        for (; s && !le(s) && !r && !a;)
          t++,
            (s = e[t]),
            s &&
    ...
    createPingPongPlane(e, t, s) {
      ...
      if (r) r.setRenderOrder(t);
        ...
        if (((r = new It(this.curtain, this.curtain.container, i)), !r)) return;
        (r.userData.id = e.local.id),
    ...
    handleMediaTextures(e, t, s) {
      ...
      if (
        ...
        const r = t.src.includes(", ") ? Ot(t.src) : t.src;
        e.loadVideo(
          r,
  ...
  function Zt() {
    se(window, "scroll", Ze),
      ve() ? se(window, "touchmove", Ee) : se(window, "mousemove", Ee),
      se(window, "routeChange", Xe),
      se(document, "mouseleave", Je),
      (oe = zt(Yt, 16)),
      ve() ? se(window, "orientationchange", oe) : se(window, "resize", oe),
      se(document, ce, qe),
      (ke = !0);
  }
  function De() {
    ie(window, "mousemove", Ee),
      ie(window, "touchmove", Ee),
      ie(window, "scroll", Ze),
      ie(window, "routeChange", Xe),
      ie(document, "mouseleave", Je),
      oe && (ie(window, "resize", oe), ie(window, "orientationchange", oe)),
      ie(document, ce, qe),
      (ke = !1);
  }
  function Jt(n, e, t) {
  ...
  function Ke(n) {
    ...
    return new Promise((s, i) => {
      es(e, t, n.filePath, i, n.production)
        .then((r) => {
          ...
          const c = Lt(r.history, o, Jt(h, l, d)),
            u = new qt({
              id: o,
              fps: n.fps || a.fps || 60,
              dpi: d,
...
console.log(UnicornStudio);

const Container = document.getElementById("container");
const projectSrc = Container.getAttribute("data-us-project-src");

if (projectSrc) {
  console.log(`Loading project from: ${projectSrc}`);

  UnicornStudio.addScene({
    filePath: projectSrc, // Path to the hero_noise.json file
    element: Container, // The container element
    dpi: window.devicePixelRatio, // Optional: Set DPI
    scale: 1, // Optional: Set scale
    lazyLoad: false, // Optional: Disable lazy loading
    production: true, // Optional: Enable production mode
  })
    .then((scene) => {
...
function buildScene(projectSrc) {
  // 1️⃣ Destroy previous scene
  if (currentScene) {
    currentScene.destroy();
    currentScene = null;
  }

  // 2️⃣ Add new scene to the existing container
  UnicornStudio.addScene({
    filePath: projectSrc,
    element: container,
    ...
    .then((scene) => {
      currentScene = scene; // store reference to destroy next time
      console.log("Scene initialized:", scene);
    })
    .catch((error) => console.error("Error initializing scene:", error));
}

function updateProjectSrc() {
  const projectSrc = projectSources[currentIndex];
  nameEl.style.visibility =
    projectSrc === "./hero_noise.json" ? "visible" : "hidden";
  buildScene(projectSrc);
}

// Next/Prev buttons
document.getElementById("nextBtn").addEventListener("click", () => {
  currentIndex = (currentIndex + 1) % projectSources.length;
  updateProjectSrc();
});

document.getElementById("prevBtn").addEventListener("click", () => {
  currentIndex =
    (currentIndex - 1 + projectSources.length) % projectSources.length;
  updateProjectSrc();
});
